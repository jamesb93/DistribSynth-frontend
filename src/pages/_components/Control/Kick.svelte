<script>
    ...
    import { kick } from "../../../instruments/ensemble.js";

    $: kick.membrane.octaves = $params.kick.octaves
    $: kick.membrane.frequency.rampTo($params.kick.frequency, 0.1)
...
<ControlContainer>
    ...
    <ASlider title="Frequency" min="35" max="90" bind:value={$params.kick.frequency} func={uFrequency} />
